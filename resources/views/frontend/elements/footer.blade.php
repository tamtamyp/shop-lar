<footer id="footer">
                        ...
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-content">
                                <div class="wrap-list-item wrap-gallery">
                                    <img src="{{ asset('templates/frontend/assets/images/payment.png') }}"
                                ...
                                <div class="wrap-list-item apps-list">
                                    <ul>
                                        <li><a href="#" class="link-to-item" title="our application on apple store">
                                                <figure><img
                                                        src="{{ asset('templates/frontend/assets/images/brands/apple-store.png') }}"
                                                        alt="apple store" width="128" height="36"></figure>
                                            </a></li>
                                        <li><a href="#" class="link-to-item"
                                                title="our application on google play store">
                                                <figure><img
                                                        src="{{ asset('templates/frontend/assets/images/brands/google-play-store.png') }}"
    ...
    <div id="back-to-top" class="back-to-top" data-toggle="tooltip" data-placement="left" title="Trở lên đầu trang">
        <img style="width:40px; height:40px;"
            src="{{ asset('templates/frontend/assets/images/icon-back-to-top-black-150x150.png') }}" alt="">
    </div>
