@php
$prefix = 'category';
// function showCategories($items, $parent_id = 0, $char = '')
// {
...
//             echo '<tr>';
//             echo '<td class=""><input class="selectbox" name="ids[]" type="checkbox" value="' . $id . '"></td>';
//             echo '<td>' . $item['id'] . '</td>';
//             echo '<td>' . $char . $item['name'] . '</td>';
//             $class = $status == 'active' ? 'btn-success' : 'btn-danger';
//             echo '<td><button
//                         data-url="' .
//                 route($prefix . '/status', ['status' => $status, 'id' => $id]) .
//                 '"
//                         type="button" data-class="btn-success"
//                         class="btn btn-round status-ajax '.$class.' "
//                         >' .
//                 $item['status'] .
//                 '</button></td>';
//             $displaylist = $display == 'list' ? 'selected' : '';
//             $displaygrid = $display == 'grid' ? 'selected' : '';
//             echo '<td><select
//                         data-url="' .
//                 route($prefix . '/display', ['display' => $display, 'id' => $id]) .
//                 '"
//                         class="form-control col-md-7 col-xs-12 change-ajax" id="display"
//                         name="display">
//                         <option ' .
//                 $displaylist .
//                 ' value="list">
...
//             showCategories($items, $item['id'], $char . '|---');
//         }
//     }
// }
@endphp
