                            ...
                            <div class="x_content">
                                ...
                                @foreach ($items as $item)
                                    @php
                                        ...
                                        $email = $item['email'];
                                        $thumb = Templates::showImage($controllerName, $item['avatar'], $name);
                                        $status = $item['status'];
                                        $level = $item['level'];
                                    ...
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" name="name" required="required"
                                                    class="form-control col-md-7 col-xs-12" value="{{ $name }}"readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Level<span>*</span></label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="form-control col-md-7 col-xs-12" id="level" name="level">
                                                    <option value="default">Select level</option>
                                                    <option value="admin" {{ $level == 'admin' ? 'selected' : '' }}>
                                                        Admin</option>
                                                    <option value="member"
                                                        {{ $level == 'member' ? 'selected' : '' }}>Thành viên đăng ký
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Đổi password </label>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="thumb">Ảnh đại diện
